        ...
        <div className="wrapper bg-[#f6f6f6]">
          ...
          <form method="post" className="flex flex-col gap-5 mt-[5%]">
            <div className="flex sm:flex-row flex-col gap-5">
              ...
              <div className="flex flex-col gap-5 flex-1">
                ...
                >
                  ...
                  <Option onClick={handlerClickStyle}>SERVICE & PRODUCT</Option>
                  <Option onClick={handlerClickStyle}>MPRESS AND MEDIA</Option>
                </Select>
            ...
            <Typography>
              ...
              the enquiry form, including the contact details you provide there,
              will be stored by us for the purpose of processing the enquiry and
              in the event of follow-up questions. We do not pass on your data
              to third parties without your express consent. You can find our
              data protection regulations here.
            </Typography>
