   ...
   return (
      <>
         ...
         <div id="dis" className="px-[10%] py-[5%]">
            <Typography>
               We have compiled the dimensions below so that you can be sure
               that all your equipment will fit. If you have any further
            ...
            <div className="mt-20 flex flex-col flex-1">
               <Typography>
                  <b>KIRRA:</b> Inflatable tent for 2 people + a lot of
                  equipment
                  <img
