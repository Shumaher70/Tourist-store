      ...
      <div>
         ...
         <div ref={navMissionRef} id="mission" className="px-[10%] py-[5%]">
            <div className="flex flex-col items-center text-center">
               ...
               <Typography className="mt-5">
                  ...
                  fabrics, fairer working conditions, better trained
                  manufacturers, cleaner production routes and more thoughtful
                  designs. They say quality is about meeting expectations. Why
                  just meet them when you can exceed them? We keep going until
                  there is nothing left to improve. Is that an unrealistic goal?
               </Typography>
            </div>
            <div className="mt-20 flex gap-10 flex-wrap justify-between">
               ...
               <div className="w-full h-full lg:w-[34vw] lg:flex justify-center items-center">
                  <Typography className="w-full h-full lg:w-[30vw] lg:h-[30vh]">
                     "We make products that last a long time, are high quality
                     and very timeless. For us, that's the best way to combat
                     waste of resources."
                  </Typography>
               </div>
         ...
         <div className="px-[10%] py-[5%] flex flex-col sm:flex-row gap-5 bg-[#f6f6f6] border-y-[1px] border-black ">
            <div className="flex flex-col sm:items-start items-center flex-1 gap-5 ">
               ...
               <Typography>
                  All HEIMPLANET-products are built to withstand the harsh test
                  of time. We use only durable materials that are crafted to
                  ensure long-lasting performance in the toughest environments.
               </Typography>
            </div>
            ...
            <div className="flex flex-col sm:items-start items-center flex-1 gap-5">
               ...
               <Typography>
                  ...
                  recognize the need to protect the natural environment. They
                  realize that profit and loss are directly linked to the health
                  of the environment.
               </Typography>
            </div>
            ...
            <div className="flex flex-col sm:items-start items-center flex-1 gap-5">
               ...
               <Typography>
                  ...
                  off-the-shelf fabric to achieve our goals. Instead, we
                  invested more time and energy in the - fundamental -
                  development of a fabric concept.
               </Typography>
            </div>
         </div>
         ...
         <div className="flex flex-col gap-5 px-[10%] py-[5%] relative">
            ...
            <Typography className=" text-white lg:w-[65%] w-full">
               ...
               You have to rely on less and you can discover more. When you get
               involved in the experience, you not only get to know new things,
               but also yourself.
            </Typography>
            <div className="flex gap-5">
               <NavLink
