   ...
   return (
      <>
         <TemplatePage
            ...
            id="dis"
         />
         <Typography id="dis" className="px-[10%] py-[5%]">
            ...
            long-lasting performance even in the toughest environments. We take
            full responsibility for the high quality of our products. If you
            ever find that one of our products is not performing as promised,
            simply contact us here or contact one of our official dealers. If
            your product has any problems and does not meet our standards, we
            will repair or exchange it free of charge. In other cases, we will
            arrange for your product to be repaired for a reasonable fee. If
            repair is not possible, we will offer you the option of adding the
            product to our Re-Store/Recyclingprogram . Please understand that we
            cannot be held responsible for damage caused by improper use or the
            natural life of the product. If you have any questions, please
            contact us or one of our certified dealers. For international
            warranty claims, the customer is responsible for the cost of
            shipping to our warehouse, import fees, duties, levies and VAT. If
