   ...
   return (
      <>
        ...
        Become Heimplanet Affiliate Partner"
         ...
         <div id="dis" className="px-[20%] py-[5%]">
            <Typography>
               As an affiliate partner you have the opportunity to promote our
               products and earn commissions. For each sale generated by your
               link, you will receive a commission of 7% and you can move up in
               the commission from a certain number of sales.
            </Typography>
            ...
            <ul className="list-disc">
               ...
               <li>
                  A cookie lifetime of 14 days - once your link is clicked, you
                  will be credited with sales for 2 weeks
               </li>
               <li>
