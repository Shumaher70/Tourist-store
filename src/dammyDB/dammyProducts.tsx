         ...
         sleepingThermarestNeoairXlite: {
            mainSection: {
               ...
               mainImg: [
                  ...
                  'mainImg/sleepingThermarestNeoairXlite2.webp',
                  'mainImg/sleepingThermarestNeoairXlite3.webp',
                  'mainImg/sleepingThermarestNeoairXlite4.webp',
               ],
            },
            details: {
               detailsDesctioption: [
