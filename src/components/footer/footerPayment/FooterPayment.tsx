         ...
         <div className="flex-col flex-wrap">
            ...
            <div className="flex">
               ...
               <div className="w-[10%] ml-2 cursor-pointer">
                  ...
                  >
                     <img
                        src={require('./paymentMethodImg/visa.webp')}
                        alt="visa"
                     />
                  </NavLink>
               </div>
         ...
         <div className="flex-col">
            ...
            <div className="flex">
               <div className="w-[15%] cursor-pointer ">
                  <NavLink
                     onClick={() => window.scrollTo(0, 0)}
                     to="https://www.instagram.com/heimplanet/"
                  >
                     <img
               ...
               <div className="w-[15%] cursor-pointer ml-2">
                  <NavLink
                     onClick={() => window.scrollTo(0, 0)}
                     to="https://www.pinterest.de/heimplanet/"
                  >
                     <img
               ...
               <div className="w-[15%] cursor-pointer ml-2">
                  <NavLink
                     onClick={() => window.scrollTo(0, 0)}
                     to="https://www.facebook.com/heimplanet/"
                  >
                     <img
                        src={require('./socialImg/faceBook.webp')}
                        alt="faceBook"
                     />
                  </NavLink>
               </div>
               <div className="w-[15%] cursor-pointer ml-2">
                  <NavLink
                     onClick={() => window.scrollTo(0, 0)}
                     to="https://www.youtube.com/channel/UCxPmJJM8vkH4GDqhaK1HFag"
                  >
                     <img
                        src={require('./socialImg/youtube.webp')}
                        alt="youtube"
                     />
                  </NavLink>
               </div>
